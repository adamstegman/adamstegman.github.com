  ...
  <Layout>
    <Container>
      ...
      <section>
        ...
        <p>
          I work remotely for <a href="https://www.onemedical.com">One Medical</a> from Fort Worth, Texas.
          I got my BS in CS at <a href="https://www.k-state.edu/">Kansas State University</a> and graduated in 2009.
          I've worked in several languages, but I enjoy <a href="https://www.ruby-lang.org/">Ruby</a> the most currently, with interest in the simplicity of <a href="https://golang.org">Go</a>.
      ...
      <section>
        <p>
          ...
          I've done that using devops tools like <a href="https://www.terraform.io">Terraform</a>, <a href="https://bosh.io">BOSH</a>, <a href="https://www.packer.io">Packer</a>, and <a href="https://www.chef.io">Chef</a>,
        ...
        <p>
          I started working at <a href="https://www.onemedical.com/jobs/">One Medical</a> in 2015 on the electronic medical record and provider application, <a href="/projects/1life.html">1life</a>.
        ...
        <p>
          In 2013 I accepted an offer from <a href="https://tanzu.vmware.com/labs">Pivotal Labs</a> and moved to the San Francisco bay area.
        ...
        <p>
          Previously, I lived in Kansas City and worked for <a href="https://www.cerner.com/">Cerner</a> for five years writing web applications and services at every level of the stack.
